...
public class ViewManagerInfo implements ActionListener 
{
    JFrame display;
    Container c;
    ...
    public ViewManagerInfo() 
    {
        display = new JFrame();
        display.setBounds(-5, 0, 1377, 775);
        display.setTitle("VIEW_HOTEL_MANAGER_PAGE");
        ...
        viewstddtltxt = new JLabel("🏛️ HOTEL MANAGER ");
        viewstddtltxt.setBounds(15, 70, 800, 100);
        ...
        try {
            ...
            ResultSet rs = c.s.executeQuery("select * from Manager_Info");
        ...
        ImageIcon ic = new ImageIcon(ClassLoader.getSystemResource("ManagerInfo.jpg"));
