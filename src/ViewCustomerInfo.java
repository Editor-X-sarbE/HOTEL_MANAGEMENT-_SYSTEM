...
public class ViewCustomerInfo implements ActionListener 
{
    JFrame display;
    Container c;
    ...
    public ViewCustomerInfo() 
    {
        ...
        display.setTitle("VIEW_HOTEL_ALL_CUSTOMER_PAGE");
        ...
        viewstddtltxt = new JLabel("🏛️ HOTEL ALL CUSTOMER ㊙️");
        ...
        ImageIcon ic = new ImageIcon(ClassLoader.getSystemResource("CustomerInfo.jpg"));
