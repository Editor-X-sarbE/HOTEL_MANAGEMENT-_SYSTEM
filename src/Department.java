...
public class Department implements ActionListener 
{
    ...
    public Department() {
        ...
        display.setTitle("VIEW_HOTEL_DEPARTMENT_PAGE");
        ...
        viewstddtltxt = new JLabel("🏛️ HOTEL DEPARTMENTS 🏛️");
        viewstddtltxt.setBounds(600, 0, 800, 100);
        ...
        scroll.setBounds(860, 190, 510, 555);
        c.add(scroll);
        ...
        ImageIcon ic = new ImageIcon(ClassLoader.getSystemResource("DepartmentImage.jpg"));
